...
?>
<tr>
		<th colspan='5'>Details of Device: <i><?php
...
*/
	echo "<td align='center' >";
	if ($record ["$monitorDeviceAndOidC5Name"] == "Y") {
		echo " <a href=\"oid_mgmt_config_threshold.php?oid=$record[$monitorDeviceAndOidC3Name]&oidName=$record[$monitorDeviceAndOidC4Name]&deviceIpInDetails=$deviceIp\" >View/Edit</a>";
	}else {
	    echo "<i>not statistic</i>";
	}
	echo "</td>";
...
?>
<tr>
		<td colspan='5'>Total number of oids records: <?php
		echo "$i"?><br />
