...
/*
// ORDER BY doted ipv4 // not working
function mysqlOrderByDotedIpv4($columnName){
	return " ORDER BY SUBSTRING_INDEX('$columnName','.',1)+0, ".
		"SUBSTRING_INDEX(SUBSTRING_INDEX('$columnName','.',-3),'.',1)+0, ".
		"SUBSTRING_INDEX(SUBSTRING_INDEX('$columnName','.',-2),'.',1)+0, ".
		"SUBSTRING_INDEX('$columnName','.',-1)+0 ";
}*/
...
// <select> menu
function input_select($element_name, $aElementValuePairList, $aOptionLabelPairList, $multiple = false) {
